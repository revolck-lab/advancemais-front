...
const CourseListGrid: React.FC = (): JSX.Element => {
  ...
  if (isMobile) {
    // Versão mobile
    return (
      <section className={`${Styles.pxResponsive} py-12`}>
        <div className="container mx-auto">
          <div
            className={`${Styles.responsiveFilter} flex justify-between items-center`}
          >
            <h2
              className={`${Styles.titleFilter} text-4xl font-bold text-primary`}
            >
              Todos os cursos
            </h2>
          </div>
          ...
          <div
            className={`${Styles.filter} flex flex-col lg:flex-row gap-8 text-left`}
          >
            ...
            <div className="w-full lg:w-3/4">
              <div
                className={`${Styles.gridCourses} grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8`}
              >
                    ...
                    <div className="p-6">
                      <div className="flex items-center justify-between text-sm text-neutral-500 mb-2">
                        <div className="flex items-center text-primary text-sm bg-primary-50 border border-primary-200 rounded-md p-2">
                          ...
                          <span className={`${Styles.InforDias} text-neutral`}>
                            Faltam{' '}
  ...
  return (
    <section className={`${Styles.pxResponsive} py-12`}>
      <div className="container mx-auto">
        <div
          className={`${Styles.responsiveFilter} flex justify-between items-center mb-8`}
        >
          <h2
            className={`${Styles.titleFilter} text-4xl font-bold text-primary`}
          >
        ...
        <div className={`${Styles.filter} flex flex-col lg:flex-row gap-8`}>
          <div className="w-full lg:w-1/4">
            <div className="border border-secondary border-opacity-30 rounded-lg overflow-hidden">
              <div className="bg-primary">
                <h3 className="text-lg p-4 pl-6 font-bold text-white">
