...
type SortField = 'name' | 'subject' | 'hireDate' | 'salary' | 'balance' | null
...
export default function ProfessorsPage() {
  ...
  const hasActiveFilters =
    searchTerm || statusFilter.length > 0 || subjectFilter
  ...
  return (
    <div className="container mx-auto py-6 space-y-6 bg-white px-5 border rounded-md mb-10 shadow-sm">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent>
                <p>Exportar lista de professores</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </div>
      ...
      {isLoading ? (
        ...
        <ProfessorsTable sortConfig={sortConfig} handleSort={handleSort} />
      )}
...
function Search({
  ...
  return (
    <div className="relative">
      <Input
        placeholder="Pesquisar por ID, nome, disciplina..."
